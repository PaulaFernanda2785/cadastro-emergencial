...
CREATE TABLE IF NOT EXISTS familias (
    ...
    responsavel_sexo VARCHAR(20) NULL,
    responsavel_orgao_expedidor VARCHAR(30) NULL,
    ...
    renda_familiar VARCHAR(30) NULL,
    perdas_bens_moveis TEXT NULL,
    situacao_familia VARCHAR(40) NULL,
    recebe_beneficio_social TINYINT(1) NOT NULL DEFAULT 0,
    beneficio_social_nome VARCHAR(180) NULL,
    cadastro_concluido TINYINT(1) NOT NULL DEFAULT 0,
    conclusao_observacoes TEXT NULL,
    representante_nome VARCHAR(180) NULL,
    representante_cpf VARCHAR(14) NULL,
    representante_rg VARCHAR(30) NULL,
    representante_orgao_expedidor VARCHAR(30) NULL,
